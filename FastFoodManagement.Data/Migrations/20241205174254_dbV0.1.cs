        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CCCD = table.Column<string>(type: "varchar(15)", maxLength: 15, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ComboItems_Products_ComboId",
                        column: x => x.ComboId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseInvoiceItems", x => new { x.PurchaseInvoiceId, x.IngredientId });
                    table.ForeignKey(
                        name: "FK_PurchaseInvoiceItems_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseInvoiceItems_IngredientId",
